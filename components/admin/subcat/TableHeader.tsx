...
export default function SubcatTableHeader({ sortField, sortDirection, onSort }: Props) {
  return (
    <View className="px-4 py-2 bg-gray-100 border-b border-gray-300">
      <View className="flex-row items-center">
        ...
        <Pressable
          onPress={() => onSort("catid")}
          className="w-[120px] h-[36px] justify-center items-center rounded-md bg-gray-200 mr-1"
        >
          <Text className="text-sm font-bold text-gray-800">
